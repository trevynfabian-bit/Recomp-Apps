...
- Workspace ID: `af2d7ca0-c917-4b86-ab28-72d6d1a63c9c`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/af2d7ca0-c917-4b86-ab28-72d6d1a63c9c.
...
2. `npx ngodingpakeai connect --workspace af2d7ca0-c917-4b86-ab28-72d6d1a63c9c --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/af2d7ca0-c917-4b86-ab28-72d6d1a63c9c. Only pass on links the CLI actually printed — never assemble one from an id yourself.
